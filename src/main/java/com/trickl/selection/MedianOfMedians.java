...
/**
 * Recursive selection algorithm, theoretical O(n) worst complexity. Detailed in "Foundations of
 * algorithms using Java pseudocode" By R E. Neapolitan, K Naimipour Also see:
