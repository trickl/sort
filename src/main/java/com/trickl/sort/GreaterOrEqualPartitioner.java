...
/**
 * A partitioner that divides the data set into two sets according to a pivot. A : a &lt; pivot B :
 * b >= pivot Note: values equal to the pivot are not guaranteed to be contiguous.
 *
 * @author tgee
 */
