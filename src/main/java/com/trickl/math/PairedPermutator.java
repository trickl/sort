...
/**
 * The PairedPerumator applies the same permutation to 
 * another paired dataset for every operation requested.
 * This can be set up to perform a variety of operations, the most
 * common being where the paired dataset is initialized to hold the original positions
 * of each element in the dataset. Then after several permutations are performed, the paired
 * data can be analyzed to see the composite permutation effect.
 * @author tgee
 */
